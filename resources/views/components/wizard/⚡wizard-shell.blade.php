    ...
    <div class="flex-1 px-6 py-4">
        ...
        @elseif($currentStep === 3)
            <div class="flex flex-col gap-6">
                ...
                {{-- Fix 4: AI pre-selection hint --}}
                @if($aiSuggestedLevel)
                    <div class="rounded-lg bg-rapida-blue-50 border border-rapida-blue-200 p-4 flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-body-sm font-medium text-rapida-blue-900">
                                {{ __('wizard.ai_suggests', ['level' => ucfirst($aiSuggestedLevel)]) }}
                            </p>
                            <p class="text-caption text-rapida-blue-700">
                                {{ __('wizard.ai_confirm') }}
                            </p>
                        </div>
                    </div>
                @endif
                ...
                <fieldset class="flex flex-col gap-3" wire:model.live="damageLevel">
                    <label class="flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all duration-150
                                {{ $damageLevel === 'minimal' ? 'border-green-600 bg-green-50' : 'border-slate-200 hover:border-green-400' }}">
                    ...
                    <label class="flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all duration-150
                                {{ $damageLevel === 'partial' ? 'border-amber-600 bg-amber-50' : 'border-slate-200 hover:border-amber-400' }}">
                    ...
                    <label class="flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all duration-150
                                {{ $damageLevel === 'complete' ? 'border-red-700 bg-red-50' : 'border-slate-200 hover:border-red-400' }}">
                        <input type="radio" name="damage_level" value="complete" wire:model.live="damageLevel" class="sr-only" />
                        <div class="w-4 h-4 rounded-full bg-red-600 shrink-0"></div>
                        <div class="flex-1">
        ...
        @elseif($currentStep === 6)
            <div class="flex flex-col gap-6">
                ...
                <div class="rounded-lg bg-green-50 border border-green-200 p-4 text-center">
                    <p class="text-body-sm text-green-800">{{ __('wizard.partial_submit_note') }}</p>
                </div>
            </div>
