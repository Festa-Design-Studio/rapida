...
return [
    ...
    /*
     * Operator-side mutations originate from the `undp` guard, not the
     * default `web` guard (which is for anonymous reporters / accounts).
     * Setting this here makes activity_log.causer_id resolve to the
     * UndpUser without each model needing custom causer-resolution code.
     */
    'default_auth_driver' => 'undp',
